...
<input type="checkbox" class="pull-right" id="holdDisplay" checked>
<label for="holdDisplay" class="pull-right" style="margin-left:10px;">Show on-hold bookings&nbsp;</label>
<input type="checkbox" class="pull-right" id="workDisplay">
<label for="workDisplay" class="pull-right">Show work schedule&nbsp;</label>
...
if (detectmob()){
top.location.href='<?php echo site_url("bookings/mobile") ?>';
}
...
$('#calendar').fullCalendar({
  ...
  eventRender: function(event, element) {
    ...
    if (event.source.id == 'hold' || event.source.id == 'confirm') {
      element.find('.fc-title').append(" " +event.people + "ppl");
      element.find('.fc-list-item-title').append(" " +event.people + "ppl");
    }
